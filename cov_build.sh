...
############################
# Build entservices-tools
echo "buliding entservices-tools"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-tools \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-tools --target install
echo "======================================================================================"
exit 0
